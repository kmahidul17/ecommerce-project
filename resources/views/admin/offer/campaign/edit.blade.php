        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <small id="emailHelp" class="form-text text-danger">Discount percentage are applied for all prodcut selling price</small>

                </div>
            </div>
        </div>
        <div class="form-group">
            <label for="brand-name">Campaign Image</label>
