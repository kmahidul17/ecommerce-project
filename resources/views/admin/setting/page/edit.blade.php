                            ...
                            <form role="form" action="{{route('page.update',$page->id)}}" method="post">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="page_position">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="page_description" id="summernote">{{$page->page_description}}</textarea>
                                        <small>This data will be shown on your web page</small>
                                    </div>
