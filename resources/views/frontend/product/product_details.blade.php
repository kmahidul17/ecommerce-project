                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-1 order-lg-1 order-2">
                            <ul class="image_list">
                                <li data-image="{{asset('/files/product/'.$product->thumbnail)}}"><img src="{{asset('/files/product/'.$product->thumbnail)}}" alt="">
                                </li>
                                @isset($images)
                                        ...
                                        <div class="button_container">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    ...
                                                    <a href="{{route('wishlist.add',$product->id)}}" class="btn btn-outline-primary" type="button">Add to wishlist</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <form action="{{route('review.store')}}" method="POST">
                                                ...
                                                @else
                                                    <p>Please login first to your account for submitting a review.</p>
                                                @endif
                                            </form>
                                        </div>
                                    </div>
