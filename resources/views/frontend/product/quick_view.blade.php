...
{{--                    <form action="#" method="post" id="add_cart_form">--}}
                        ...
                        <div class="form-group">
                            <div class="row">
                                @isset($product->size)
                                    <div class="col-lg-4 col-md-4">
                                        <label>Size: </label>
                                        <select class="custom-select form-control" name="size" style="min-width: 120px; margin-left: -4px;">
                                ...
                                @isset($product->color)
                                    <div class="col-lg-4 col-md-4">
                                        <label>Color: </label>
                                        <select class="custom-select form-control" name="color" style="min-width: 120px; margin-left: -4px;">
                            ...
                            <div class="col-lg-3 col-md-4" style="margin-left: -4px;">
                                <label>Quantity: </label>
                                <input type="number" min="1" max="100" name="qty" class="form-control" value="1" style="min-width: 120px; ">
                            </div>
                            </div>
                        </div>
                        <div class="button_container">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    ...
                                    @else
                                        <button class="btn btn-outline-info" type="submit" style="float: right;">
