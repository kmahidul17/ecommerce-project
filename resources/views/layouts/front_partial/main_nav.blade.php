                    ...
                    <div class="cat_menu_container">
                        ...
                        <ul class="cat_menu">
                            @foreach($category as $row)
                                ...
                                @endphp
                            <li class="hassubs">
                                <a href="{{route('categoryWise.product',$row->category_slug)}}">
                                    <img src="{{$row->icon}}" alt="" height="20" width="20" class="mr-2">   {{$row->category_name}}<i class="fas fa-chevron-right"></i>
                                </a>
                                <ul>
